...
const Education = () => {
  // Array de datos de certificados con fechas convertidas a un formato comparable
  const certifications = [
    ...
    },
    {
      ...
      date: new Date(2024, 2) // March 2024
    },
    {
      ...
      date: new Date(2023, 10) // November 2023
    },
    {
      ...
      date: new Date(2022, 5) // June 2022
    }
  ];

  // Ordenar certificados por fecha (de más antiguo a más reciente)
  certifications.sort((a, b) => a.date - b.date);

  // Separar los certificados en dos columnas
    ...
    >
      ...
      <div className="flex-1">
        ...
        <div className="mt-6 lgl:mt-14 w-full h-auto border-l-[6px] border-l-black border-opacity-30 flex flex-col gap-10">
          {column1.map((certification, index) => (
            <ResumeCard
              key={index}
      ...
      <div className="flex-1">
        ...
        <div className="mt-6 lgl:mt-14 w-full h-auto border-l-[6px] border-l-black border-opacity-30 flex flex-col gap-10">
          {column2.map((certification, index) => (
            <ResumeCard
              key={index}
              title={certification.title}
              subTitle={certification.subTitle}
